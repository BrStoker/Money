        ...
        <div class="form__footer">
            <div class="form__actions actions">
                <div class="actions__list">
                    ...
                    <div class="actions__item">
                        <div class="actions__media">
                            <svg id="record-button" class="send-button record_button_chat">
                    ...
                    <div class="actions__item">
                        <div class="actions__media">
                            <svg class="send-button" onclick="sendMessageChat()"><use xlink:href="/image/svg/sprite.svg#sendIco"></use></svg>
                        </div>
                    </div>
