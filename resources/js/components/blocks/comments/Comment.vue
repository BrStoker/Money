<template lang="pug">
  ...
  DivElement(classCss="series, no-wrap" :data-comment_id="commentId")
      ...
      DivElement(classCss="tooltips" v-if="user.auth")
        DivElement(classCss="tooltips__list")
          ...
          DivElement(classCss="tooltips__item, tooltips__item_dinamic")
            DivElement(classCss="tooltips__media" :onclick="()=> setLike()")
...
import ChildComment from '@/js/components/blocks/comments/ChildComment'
