...
class ArticleCommentCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\ArticleComment::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/article-comment');
        CRUD::setEntityNameStrings('', 'Комментарии к статьям');
    }
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::setColumns([
            [
                ...
                'label' => 'Активность',
                'type'  => 'boolean',
                'options' => \App\Models\ArticleComment::$activities
            ],[
                'name' => 'value',
                'label' => 'Текст'
            ]
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::setValidation(ArticleCommentRequest::class);
