...
class ArticleGroupCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\ArticleGroup::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/article-group');
        CRUD::setEntityNameStrings('', 'Категории статей');
    }
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::setColumns([
            [
                ...
                'label' => 'Активность',
                'type'  => 'boolean',
                'options' => \App\Models\ArticleGroup::$activities
            ],[
                'name' => 'sort',
                'label' => 'Сортировка'
            ],[
