...
class CoursesTypeCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\CoursesType::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/courses-type');
        CRUD::setEntityNameStrings('', 'Тип курса');
    }
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::setColumns([
            [
                ...
                'label' => 'Активность',
                'type'  => 'boolean',
                'options' => \App\Models\CoursesType::$activities
            ],[
                'name' => 'sort',
                'label' => 'Сортировка'
            ],[
