...
<div class="layout layout_ready-load">
    ...
    <div class="layout__middle">
        ...
        <div class="layout__overflow">
            @include('Chatify::layouts.breadcrumbs')
            @include('Chatify::layouts.chatBody')
            @include('Chatify::layouts.footer')
        </div>
    </div>
    @include('Chatify::layouts.modals')
</div>
{{--<div class="messenger" style="display: none !important;">--}}
...
{{--                <span class="ic-connected">Загружено</span>--}}
{{--                <span class="ic-connecting">Соединение...</span>--}}
{{--                <span class="ic-noInternet">Ошибка соединения</span>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--            <div class="messages">--}}
{{--                <p class="message-hint center-el"><span>Выберите чат для начала общения</span></p>--}}
{{--            </div>--}}
{{--            --}}{{-- Typing indicator --}}
